    ...
    <div className="navbar">
      ...
      >
        ...
        <button onClick={() => props.history.push(`/notifications`)}>
          <NotificationsIcon style={context.unseen ? { color: "red" } : null} />
        </button>
        <button
          onClick={() => props.history.push(`/profile/${context.currentUser}`)}
        >
          <img src={context.userData.profileimage} alt="profile_pic" />
        </button>
      ...
      >
        ...
        <button onClick={() => props.history.push(`/register`)}>Signup</button>
      </div>
